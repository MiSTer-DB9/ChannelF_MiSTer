...
UPSTREAM_REPO="https://github.com/MiSTer-devel/ChannelF_MiSTer.git"
CORE_NAME=(ChannelF)
...
UPSTREAM_CORE_NAME=(ChannelF)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(ChannelF.qpf)
COMPILATION_OUTPUT=(output_files/ChannelF.rbf)
